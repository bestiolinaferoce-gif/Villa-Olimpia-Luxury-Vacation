...
export const metadata: Metadata = generateMetadata({
  ...
  description:
    "Cosa vedere a Le Castella: Castello Aragonese, centro storico, spiagge e cosa fare la sera. Guida pratica al borgo, a 8 minuti da Villa Olimpia Capo Rizzuto.",
  path: "/le-castella",
  keywords: [
