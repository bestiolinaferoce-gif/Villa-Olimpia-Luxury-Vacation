...
export default function HomePage() {
  ...
  const services = [
    ...
    {
      icon: Car,
      title: t('services.items.parking.title'),
      description: t('services.items.parking.description'),
    },
    {
      icon: Waves,
      title: t('services.items.seaView.title'),
      description: t('services.items.seaView.description'),
    },
    {
      icon: Utensils,
    ...
    {
      icon: Star,
      title: t('services.items.premium.title'),
      description: t('services.items.premium.description'),
    },
  ]
          ...
          <ScrollReveal>
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full mb-4">
                ...
                <span className="text-sm font-semibold text-primary">{t('featured.mostBooked')}</span>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                icon: Umbrella,
                title: t('whyChoose.items.privilegedLocation.title'),
                text: t('whyChoose.items.privilegedLocation.text')
              },
              {
                icon: Waves,
                title: t('whyChoose.items.privatePool.title'),
                text: t('whyChoose.items.privatePool.text')
              },
              {
                icon: Sparkles,
                title: t('whyChoose.items.premiumComfort.title'),
                text: t('whyChoose.items.premiumComfort.text')
              }
            ].map((item, i) => {
        ...
        <div className="container mx-auto px-4">
          <ScrollReveal>
            <div className="text-center mb-12">
              ...
              >
                {t('reviews.description')} <span className="font-bold text-primary text-xl">{t('reviews.descriptionRating')}</span> {t('reviews.descriptionStars')} <span className="font-bold text-primary text-xl">{t('reviews.descriptionCount')}</span> {t('reviews.descriptionReviews')}
              </motion.p>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <ScrollReveal>
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-playfair font-bold mb-4">{t('faq.title')}</h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                {t('faq.description')}
              </p>
            </div>
          ...
          <div className="space-y-6">
            {[
              {
                q: t('faq.items.beachDistance.q'),
                a: t('faq.items.beachDistance.a')
              },
              {
                q: t('faq.items.parking.q'),
                a: t('faq.items.parking.a')
              },
              {
                q: t('faq.items.pool.q'),
                a: t('faq.items.pool.a')
              },
              {
                q: t('faq.items.checkIn.q'),
                a: t('faq.items.checkIn.a')
              }
            ].map((faq, i) => (
        ...
        <div className="container mx-auto px-4">
          <ScrollReveal>
            ...
            <div className="flex justify-center items-center gap-8 md:gap-12 flex-wrap">
              {[
                { label: t('trustBadges.items.booking.label'), name: t('trustBadges.items.booking.name'), color: "text-primary", icon: "🏆" },
                { label: t('trustBadges.items.airbnb.label'), name: t('trustBadges.items.airbnb.name'), color: "text-primary", icon: "⭐" },
                { label: t('trustBadges.items.protected.label'), name: t('trustBadges.items.protected.name'), color: "text-turquoise", icon: "🌊" }
              ].map((badge, i) => (
                <motion.div
                  key={i}
          ...
          <ScrollReveal delay={0.2}>
            ...
            <div className="flex items-center justify-center gap-4 mb-6 flex-wrap">
              <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full border border-white/30">
                <span className="text-white text-sm font-semibold">✅ {t('trustBadges.badges.certified')}</span>
              </div>
              <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full border border-white/30">
                <span className="text-white text-sm font-semibold">🏆 {t('trustBadges.badges.superhost')}</span>
              </div>
              <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full border border-white/30">
                <span className="text-white text-sm font-semibold">🔒 {t('trustBadges.badges.secure')}</span>
              </div>
            </div>
            ...
            >
              <div className="inline-flex items-center gap-2 bg-green-500/90 backdrop-blur-sm px-6 py-3 rounded-full border border-green-300/50 shadow-lg">
                <span className="text-white text-base font-bold">💰 {t('cta.saveUpTo')}</span>
              </div>
            </motion.div>
