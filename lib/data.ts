...
export const apartments: Apartment[] = [
  ...
  },
  {
    ...
    fullDescription: "Questo accogliente studio è perfetto per viaggiatori singoli o coppie che cercano comfort e praticità. Nonostante le dimensioni compatte, offre tutto il necessario per un soggiorno confortevole, con angolo cottura attrezzato e zona living ben organizzata.",
    image: "🏠",
    images: ["🏠", "🛋️", "☕"],
    guests: 2,
    bedrooms: 0,
  ...
  },
  {
    ...
    fullDescription: "Perfetto per famiglie con bambini, questo appartamento spazioso offre due camere da letto e due bagni. Il giardino privato è ideale per i più piccoli, mentre la cucina completa permette di preparare pasti comodamente. Culla e seggiolone disponibili su richiesta.",
    image: "👨‍👩‍👧‍👦",
    images: ["👨‍👩‍👧‍👦", "🛏️", "🎮"],
    guests: 5,
    bedrooms: 2,
  ...
  },
  {
    ...
    fullDescription: "Questo loft moderno combina design contemporaneo e funzionalità. L'open space luminoso crea un ambiente accogliente e spazioso. Perfetto per giovani coppie o professionisti che apprezzano lo stile minimalista e la vista sul mare.",
    image: "🏙️",
    images: ["🏙️", "💡", "🎨"],
    guests: 3,
    bedrooms: 1,
  ...
  },
  {
    ...
    fullDescription: "Ideale per chi cerca tranquillità e privacy, questo appartamento offre un giardino privato completamente recintato. Perfetto per cene all'aperto, il barbecue permette di cucinare all'aria aperta. La posizione tranquilla garantisce riposo e relax.",
    image: "🌳",
    images: ["🌳", "🌸", "🪑"],
    guests: 4,
    bedrooms: 2,
  ...
  },
  {
    ...
    fullDescription: "Creata appositamente per coppie in cerca di romanticismo, questa suite offre una vista spettacolare sul tramonto. Il balcone privato e la jacuzzi rendono ogni momento speciale. Colazione inclusa per iniziare la giornata nel migliore dei modi.",
    image: "💑",
    images: ["💑", "🕯️", "🍾"],
    guests: 2,
    bedrooms: 1,
  ...
  },
  {
    ...
    fullDescription: "Questo appartamento offre una vista unica sulle colline calabresi e il mare in lontananza. La posizione elevata garantisce massima tranquillità e privacy. La terrazza è perfetta per godere dei panorami mozzafiato e del clima mediterraneo.",
    image: "⛰️",
    images: ["⛰️", "🌄", "🌿"],
    guests: 4,
    bedrooms: 2,
