 ...
 * BandieraBluBadge
 * ----------------
 * Badge informativo Bandiera Blu 2026 — riutilizzabile su tutti i siti delle
 * strutture (Armenes, Villa Olimpia, Tulipano, Mare Capo Rizzuto, Le Farfalle,
 * Lungomare Crotone). NON è il logo ufficiale FEE: è un badge originale che
 * comunica un dato pubblico verificabile.
 *
 * Esempi d'uso:
 *
 *   <BandieraBluBadge />                                    // full circle 180px
 *   <BandieraBluBadge variant="compact" size={96} />        // sticker piccolo
 *   <BandieraBluBadge variant="banner" location="Capo Piccolo" />
 *
 * Props:
 * - variant:  "full" | "compact" | "banner"   (default "full")
 * - size:     number   – lato in px del cerchio (full/compact); larghezza banner
 * - location: string   – nome località/struttura (default "Isola di Capo Rizzuto")
 * - year:     number   – anno del riconoscimento (default 2026)
 * - className?: string – passato al wrapper SVG
 */
