...
> = {
  de: {
    ...
    body: "Villa Olimpia liegt in Capopiccolo im Meeresschutzgebiet Capo Rizzuto: 9 vollausgestattete Apartments mit Gemeinschafts-Außenpool, mediterranem Garten und ruhiger Lage – ca. 100 m vom Sandstrand entfernt. Ideal für Familien und Paare, die das echte Süditalien erleben möchten. Verfügbarkeit direkt anfragen.",
  ...
  fr: {
    ...
    body: "Villa Olimpia à Capopiccolo est situé dans l'Aire Marine Protégée de Capo Rizzuto : 9 appartements entièrement équipés avec piscine extérieure partagée, jardin méditerranéen et cadre calme, à environ 100 m de la plage. L'Italie authentique, loin des foules. Contactez-nous directement pour les disponibilités.",
