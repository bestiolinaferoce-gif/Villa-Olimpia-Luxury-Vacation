...
export type LeCastellaPageViewProps = {
  contactHref?: string
  capoRizzutoHref?: string
}
...
export function LeCastellaPageView({
  contactHref = "/contatti",
  capoRizzutoHref = "/capo-rizzuto",
}: LeCastellaPageViewProps) {
  return (
