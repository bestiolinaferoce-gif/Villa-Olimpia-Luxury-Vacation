...
function CTAButtons() {
  ...
  const contactHref = `${localizeIfTranslated("/contatti", locale)}?source=home_main_cta#prenota`
...
function getApartmentCardDescription(apartment: Apartment, locale: string, guestsLabel: string, bedroomsLabel: string) {
  if (locale === "it") {
    return apartment.description || apartment.fullDescription || ""
  }
            ...
            {featuredApartments.map((apartment, index) => (
              <ScrollReveal key={apartment.id} delay={index * 0.15}>
                <ApartmentCard
                  ...
                  name={apartment.name}
                  description={getApartmentCardDescription(apartment, locale, t.apartments.guests, t.apartments.bedrooms)}
